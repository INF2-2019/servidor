package biblioteca.alunos.repository;
...
public class AlunosRepository {
	...
	public boolean checarAutorizacaoOperador(HttpServletRequest request, HttpServletResponse response) {
		BibliotecaAutenticador x = new BibliotecaAutenticador(request, response);
		return x.cargoLogado() == BibliotecaCargos.OPERADOR;
	}
